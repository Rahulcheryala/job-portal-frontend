  ...
  return (
    <nav className="w-full bg-white sm:h-16 h-14 flex justify-between items-center sm:px-10 px-4 mt-1">
      ...
      >
        ...
        />
        <span className="sr-only">QuickHire Logo</span>
      </Link>
        ...
        {isAuthenticated ? (
          <>
            <Link
              ...
              className="rounded-full bg-gray-300 from-purple-500 via-indigo-500 to-pink-500 bg-[length:_400%_400%] p-[2.5px] [animation-duration:_6s] animate-background hover:bg-gradient-to-r group min-[405px]:inline-block hidden"
            >
          ...
          <>
            <Link
              ...
              className="rounded-full bg-gray-300 from-purple-500 via-indigo-500 to-pink-500 bg-[length:_400%_400%] p-[2.5px] [animation-duration:_6s] animate-background hover:bg-gradient-to-r group min-[405px]:inline-block hidden"
            >
              <span className="rounded-full bg-blue-500 group-hover:bg-white px-5 py-2 font-medium text-white group-hover:text-blue-500 transition-colors duration-200 block whitespace-nowrap">
                Find Jobs{" "}
