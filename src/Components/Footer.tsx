...
const Footer = () => {
  return (
    <footer className="text-gray-600 sm:px-8 px-2 py-3.5 bg-gradient-to-r from-[#ECECEC] to-white">
      <div className="mx-auto flex items-center max-sm:justify-center sm:flex-row flex-col">
        <Link
